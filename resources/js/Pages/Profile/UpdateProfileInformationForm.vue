    ...
    <jet-form-section @submitted="updateProfileInformation">
        ...
        <template #form>
            ...
            <div class="col-span-6 sm:col-span-4">
                ...
                <jet-input id="url" type="url" class="mt-1 block w-full" v-model="form.url" autocomplete="url" />
                <jet-input-error :message="form.errors.url" class="mt-2" />
            </div>

<div class="col-span-6 sm:col-span-4">
            <jet-label for="status" :value=" __('Status') " />
            <select  id="status" v-model="form.status" class="mt-1 block w-full form-input rounded-md shadow-sm" wire:model.defer="state.status">
                <option value="public">{{__('Public')}}</option>
                <option value="private">{{__('Private')}}</option>
            </select>
            <jet-input-error for="status" class="mt-2" />
        </div>
